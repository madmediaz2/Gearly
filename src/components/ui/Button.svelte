<script lang="ts">
    ...
    const variantStyles = {
        ...
        error:
            "pointer-events-auto cursor-pointer bg-red-500 hover:bg-red-600 text-white text-xs py-1 px-2 rounded",
        tab: "py-2 px-4 mr-2 cursor-pointer text-gray-500 hover:text-gray-700"
    };
